...
<div>
    <div class="language-selector" v-if="this.locales.length > 1">
        <div class="btn-group btn-group-sm" role="group" data-toggle="buttons">
            <label v-for="locale in locales" @click="switchLanguage(locale)" :class="'btn btn-primary '+(isLocale(locale) ? 'active' : '')">
